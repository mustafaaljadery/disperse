...
interface Props {
  ...
  workspaceId: string;
  thumbnailSelected: any;
  setThumbnailSelected: Dispatch<SetStateAction<any>>;
}
...
async function getProjectContent(folderId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}youtube/read/thumbnailmedia`,
      {
    ...
    <div>
      {mediaData.length > 0 ? (
        ...
        <div className="flex flex-col justify-center items-center border border-dashed h-36 rounded-lg">
          ...
          <span className="mt-1.5 text-center silka-regular text-[10px] text-gray-400">
        ...
        >
          <DialogPrimitive.Content
            ...
            className={clsx(
              ...
              'w-[95vw] max-w-2xl h-[400px] rounded-lg p-4 md:w-full',
                ...
                <div className=" w-full flex flex-row space-x-7 flex-wrap">
                  {projectsData.length == 0 ? (
                    <div className="flex flex-col justify-center mt-4 items-center w-full">
                      <div className="p-2 bg-[#F6E7E7] rounded-full">
                        <svg
                          width="20"
                          height="20"
                          viewBox="0 0 24 24"
                    ...
                    <div className="w-full flex h-max flex-row space-x-4">
