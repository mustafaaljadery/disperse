...
import { PostShortNow } from '../dialog/PostShortNow';
import { ScheduleShort } from '../dialog/ScheduleShort';
...
import { YoutubeShortAvailableTimeSlots } from '../dialog/ShortAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}youtube/read/draftshortoptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}youtube/update/draftshortoptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function ShortsOptions({
  ...
  return (
    <div className="flex flex-col mt-6 w-full">
      ...
      >
        <p className="text-sm silka-medium">Short Options</p>
        {optionsOpen ? (
          <svg
            width="15"
            height="15"
              ...
              >
                ...
                >
                  ...
                  <p className="mt-2 text-xs silka-regular text-center text-gray-500">
                    Automatically repost a short after it hits a
                    certain metric.
                  </p>
                  ...
                  <input
                    ...
                    type="text"
                    className="mt-6 text-xs border border-gray-300 focus:ring-0 focus:border-[#FF0000] silka-medium text-gray-900 w-28 rounded"
                  />
                </div>
                {isPremium ? (
                  <></>
                    ...
                    >
                      <DialogPrimitive.Trigger asChild>
                        <button className="absolute w-full h-full inset-0 flex justify-center items-center z-10">
                          <button className="flex flex-row bg-[#FF0000] hover:opacity-90 space-x-2 py-2 rounded-lg px-6">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 15 15"
              ...
              <div className="flex flex-col justify-center items-center relative">
                ...
                >
                  ...
                  <p className="mt-2 text-xs text-center silka-regular text-gray-500">
                    Automatically comment under a short after a
                    certain metric is hit.
                  </p>
                  <div className="my-auto flex flex-row mt-4 space-x-2 px-2 py-1.5 bg-gray-50 rounded-lg">
                    {/*
                    <button
                  ...
                  <div className="flex flex-col w-full space-y-2 mt-6">
                    ...
                    <textarea
                      ...
                      className="h-32 border silka-medium focus:ring-0 focus:border-[#FF0000] text-gray-800 text-sm border-gray-300 rounded-lg w-full resize-none"
                    />
                  </div>
                </div>
                {isPremium ? (
      ...
      <div className="flex flex-row justify-center mt-8 items-center space-x-5">
        <DialogPrimitive.Root
          open={postNowOpen}
        ...
        >
          <DialogPrimitive.Trigger asChild>
            <button
              ...
              className="text-xs hover:opacity-90 text-white bg-[#FF0000] silka-medium px-4 py-1.5 rounded"
            >
              Post Now
            </button>
          </DialogPrimitive.Trigger>
          <PostShortNow
            ...
            setRefetchShortDrafts={setRefetchDrafts}
            shortsMedia={shortMedia}
      ...
      >
        <YoutubeShortAvailableTimeSlots
          workspaceId={workspaceId}
          userId={String(session?.user?.id)}
          draftId={draftId}
