...
import { PostVideoNow } from '../dialog/PostVideoNow';
import { ScheduleVideo } from '../dialog/ScheduleVideo';
...
import { YoutubeVideoAvailableTimeSlots } from '../dialog/VideoAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}youtube/read/draftvideooptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}youtube/update/draftvideooptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function VideoOptions({
  ...
  return (
    <div className="flex flex-col mt-6 w-full">
              ...
              <div className="flex flex-col justify-center items-center relative">
                ...
                >
                  ...
                  <p className="mt-2 text-xs silka-regular text-center text-gray-500">
                    Automatically repost a video after it hits a
                    certain metric.
                  </p>
            ...
            {autoPlugOpen ? (
              <div className="flex flex-col relative justify-center items-center">
                ...
                >
                  ...
                  <p className="mt-2 text-xs silka-regular text-center text-gray-500">
                    Automatically comment under a video after a
      ...
      <div className="flex flex-row justify-center items-center mt-8 space-x-5">
        ...
        >
          ...
          <PostVideoNow
            ...
            setRefetchVideoDrafts={setRefetchDrafts}
      ...
      >
        <YoutubeVideoAvailableTimeSlots
          workspaceId={workspaceId}
          userId={String(session?.user?.id)}
          draftId={draftId}
