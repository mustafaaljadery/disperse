...
async function postVideoNow(workspaceId: string, draftId: string) {
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}youtube/create/postvideo`,
      null,
      {
        params: {
          ...
          >
            <div className="w-full flex flex-col justify-center items-center">
              ...
              <p className="mt-2.5 text-xs silka-regular text-gray-400">
                Post video on Youtube right now.
              </p>
            </div>
                ...
                <button
                  onClick={(e) => {
                    ...
                    if (!videoMedia?.id) {
                      ...
                      postVideoNow(workspaceId, draftId).then(
                        (value) => {
