...
async function nextTimeSlot(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}youtube/create/videonexttimeslot`,
      null,
      {
        params: {
    ...
    toast.remove();
    toast.error('Error scheduling video, plesee try again.', {
      className: 'text-sm silka-medium text-gray-900',
    });
    console.log(e);
  }
          ...
          >
            <div className="w-full flex flex-col justify-center items-center">
              ...
              <p className="mt-2.5 text-xs silka-regular text-gray-400">
                Schedule video to be posted on Youtube.
              </p>
            </div>
            ...
            <div className="mt-7 flex flex-col space-y-2.5">
              <button
                onClick={(e) => {
                  ...
                  setIsOpen(false);
                  if (!videoMedia?.id) {
                    toast.error('Please select a video to post!', {
                      className: 'text-sm silka-medium text-gray-900',
                    });
                  } else {
