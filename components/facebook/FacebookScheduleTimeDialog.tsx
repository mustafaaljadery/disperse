...
async function getPostingSchedule(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}facebook/read/myschedule`,
      {
        params: {
...
async function createSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/create/scheduletime`,
      null,
      {
        params: {
          workspaceId: workspaceId,
...
async function deleteSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/delete/schedule`,
      null,
      {
        params: {
...
async function updateSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/update/schedule`,
      null,
      {
        params: {
          scheduleId: scheduleId,
          ...
          >
            <CheckboxPrimitive.Root
              ...
              className={cx(
                ...
                'radix-state-checked:bg-[#066CE5] radix-state-unchecked:bg-gray-100',
                'focus:outline-none focus-visible:ring focus-visible:ring-[#066CE5] focus-visible:ring-opacity-75'
              )}
            >
...
export function FacebookScheduleTimeDialog({
  isOpen,
  workspaceId,
  userId,
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <div className="flex flex-col justify-center items-center space-y-1.5">
              ...
              <p className="text-xs silka-regular text-gray-400">
                Facebook schedule for posts to be scheduled on.
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col justify-start items-start w-full">
              <select
                ...
                className="focus:ring-0 focus:border-[#066CE5] w-24 py-1 rounded border border-gray-300 silka-medium text-sm text-gray-900"
              >
