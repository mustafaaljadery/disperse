...
export function FacebookMenu({ workspaceId, router, title }: Props) {
  return (
    <header className="flex flex-col mt-6 sm:px-1 md:px-6 lg:px-1 xl:px-24 2xl:px-32">
      <div className="flex flex-col space-y-6 px-2 md:px-2 lg:px-4 xl:px-6 2xl:px-8">
        <div className="flex flex-row justify-between items-between">
          ...
          <Link
            href={'/' + workspaceId + '/facebook/posts'}
            legacyBehavior
          >
        ...
        <div className="flex flex-row space-x-2">
          <Link
            ...
            className={
              ...
              (router.pathname == '/[workspaceId]/facebook'
                ? 'silka-semibold underline underline-offset-[21px] z-10 decoration-2 decoration-[#066CE5] text-[#353535]'
          ...
          <Link
            ...
            className={
              'hover:bg-gray-100 rounded py-1 px-3 text-xs md:text-sm ' +
              (router.pathname == '/[workspaceId]/facebook/posts'
                ? 'silka-semibold underline underline-offset-[21px] z-10 decoration-2 decoration-[#066CE5] text-[#353535]'
                : 'text-[#848484] silka-medium')
            }
          >
          ...
          <Link
            href={'/' + workspaceId + '/facebook/analytics'}
            className={
              'hover:bg-gray-100 rounded py-1 px-3 text-xs md:text-sm ' +
              (router.pathname == '/[workspaceId]/facebook/analytics'
                ? 'silka-semibold underline underline-offset-[21px] z-10 decoration-2 decoration-[#066CE5] text-[#353535]'
                : 'text-[#848484] silka-medium')
            }
          >
