...
async function createScheduledText(
  workspaceId: string,
  userId: string,
  draftId: string,
  date: string,
      ...
      <button
        onClick={(e) => {
          ...
          toast.promise(
            ...
            {
              success: 'Successfully Scheduled Text!',
              error: 'Error scheduling text, please try again.',
              loading: 'Scheduling Text...',
            },
...
export function FacebookTextAvailableTimeSlots({
  workspaceId,
  userId,
  draftId,
  isOpen,
