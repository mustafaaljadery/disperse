...
import { FacebookPostSlideshowNow } from '../dialogs/PostSlideshowNow';
import { FacebookScheduleSlideshow } from '../dialogs/ScheduleSlideshow';
import { FacebookSlideshowAvailableTimeSlots } from '../dialogs/SlideshowAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}facebook/read/draftslideshowoptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/update/draftslideshowoptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function FacebookSlideshowOptions({
  workspaceId,
  draftId,
  postText,
  slideshowMedia,
  ...
  return (
    <div className="flex flex-col mt-6 w-full">
              ...
              <div className="flex flex-col justify-center relative items-center">
                ...
                >
                  ...
                  <input
                    ...
                    type="text"
                    className="mt-6 text-xs border border-gray-300 focus:ring-0 focus:border-[#0674E8] silka-medium text-gray-900 w-28 rounded"
                  />
                </div>
                {isPremium ? (
                  <></>
                    ...
                    >
                      <DialogPrimitive.Trigger asChild>
                        <button className="absolute w-full h-full inset-0 flex justify-center items-center z-10">
                          <button className="flex flex-row bg-[#066CE5] hover:opacity-90 space-x-2 py-2 rounded-lg px-6">
                            <svg
                              width="14"
                              height="14"
                              viewBox="0 0 15 15"
                ...
                >
                  ...
                  <div className="flex flex-col w-full space-y-2 mt-6">
                    ...
                    <textarea
                      ...
                      className="h-32 border silka-medium focus:ring-0 focus:border-[#0674E8] text-gray-800 text-sm border-gray-300 rounded-lg w-full resize-none"
                    />
                  </div>
                </div>
                {isPremium ? (
      ...
      <div className="flex flex-row w-full justify-center items-center mt-8 space-x-5">
        ...
        >
          <DialogPrimitive.Trigger asChild>
            <button
              ...
              className="text-xs hover:opacity-90 text-white bg-[#0674E8] silka-medium px-4 py-1.5 border rounded"
            >
              Post Now
            </button>
          </DialogPrimitive.Trigger>
          <FacebookPostSlideshowNow
            isOpen={postNowOpen}
            workspaceId={workspaceId}
            draftId={draftId}
        ...
        >
          ...
          <FacebookScheduleSlideshow
            ...
            draftId={draftId}
            setRefetchDrafts={setRefetchSlideshowDrafts}
            setSelectedSlideshow={setSelectedSlideshow}
            setOptionsOpen={setOptionsOpen}
            setAutoPlugOpen={setAutoPlugOpen}
            setAutoRepostOpen={setAutoRepostOpen}
      ...
      >
        <FacebookSlideshowAvailableTimeSlots
