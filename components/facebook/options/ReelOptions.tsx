...
import { FacebookScheduleReel } from '../dialogs/ScheduleReel';
import { FacebookPostReelNow } from '../dialogs/PostReelNow';
import { FacbeookReelAvailableTimeSlots } from '../dialogs/ReelAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}facebook/read/draftreeloptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/update/draftreeloptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function FacebookReelOptions({
  workspaceId,
  draftId,
  postText,
  reelMedia,
  ...
  return (
    <div className="flex flex-col mt-6 w-full">
      ...
      >
        <FacbeookReelAvailableTimeSlots
