...
import { FacebookPostVideoNow } from '../dialogs/PostVideoNow';
import { FacebookScheduleVideo } from '../dialogs/ScheduleVideo';
import { FacebookVideoAvailableTimeSlots } from '../dialogs/VideoAvailableTimeslots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}facebook/read/draftvideooptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/update/draftvideooptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function FacebookVideoOptions({
  workspaceId,
  draftId,
  postText,
  videoMedia,
  ...
  return (
    <div className="flex flex-col mt-6 w-full">
          ...
          <div className="flex flex-col space-y-4">
            ...
            {autoRepostOpen ? (
              <div className="flex flex-col justify-center relative items-center">
                <div
                  className={
                    'flex flex-col jusitfy-center items-center ' +
                    (isPremium ? '' : 'blur-[2px]')
                  }
                >
      ...
      >
        <FacebookVideoAvailableTimeSlots
