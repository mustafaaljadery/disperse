...
import { FacebookScheduleImage } from '../dialogs/ScheduleImage';
import { FacebookPostImageNow } from '../dialogs/PostImageNow';
import { FacebookImageAvailableTimeslots } from '../dialogs/ImageAvailableTimeslots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}facebook/read/draftimageoptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/update/draftimageoptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function FacebookImageOptions({
  workspaceId,
  draftId,
  postText,
  ...
  return (
    <div className="flex flex-col mt-6 w-full">
              ...
              <div className="flex flex-col justify-center items-center relative">
                ...
                >
                  ...
                  <input
                    ...
                    type="text"
                    className="mt-6 text-xs border border-gray-300 focus:ring-0 focus:border-[#066CE5] silka-medium text-gray-900 w-28 rounded"
                  />
                </div>
                {isPremium ? (
                  <></>
                ...
                >
                  ...
                  <div className="flex flex-col w-full space-y-2 mt-6">
                    ...
                    <textarea
                      ...
                      className="h-32 border silka-medium focus:ring-0 focus:border-[#066CE5] text-gray-800 text-sm border-gray-300 rounded-lg w-full resize-none"
                    />
                  </div>
                </div>
                {isPremium ? (
      ...
      <div className="flex flex-row w-full justify-center items-center mt-8 space-x-5">
        ...
        >
          <DialogPrimitive.Trigger asChild>
            <button
              ...
              className="text-xs hover:opacity-90 text-white bg-[#066CE5] silka-medium px-4 py-1.5 border rounded"
            >
              Post Now
            </button>
          </DialogPrimitive.Trigger>
          <FacebookPostImageNow
            isOpen={postNowOpen}
        ...
        >
          ...
          <FacebookScheduleImage
            ...
            draftId={draftId}
            setRefetchDrafts={setRefetchImageDrafts}
            setSelectedImage={setSelectedImage}
            setImageMedia={setImageMedia}
            imageMedia={imageMedia}
            setOptionsOpen={setOptionsOpen}
      ...
      >
        <FacebookImageAvailableTimeslots
