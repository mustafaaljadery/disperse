...
import { FacebookPostTextNow } from '../dialogs/PostTextNow';
import { FacebookScheduleText } from '../dialogs/ScheduleText';
import { FacebookTextAvailableTimeSlots } from '../dialogs/TextAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}facebook/read/drafttextoptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}facebook/update/drafttextoptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function FacebookTextOptions({
  workspaceId,
  draftId,
  postText,
  ...
  return (
    <div className="flex flex-col mt-6 w-full">
      ...
      >
        <FacebookTextAvailableTimeSlots
