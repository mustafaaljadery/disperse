...
import { InstagramPickPost } from './dialog/PickPost';
import { InstagramScheduleTimesDialog } from './ScheduleTimes';
...
async function unscheduleImage(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/delete/scheduledimage`,
      null,
      {
        params: {
...
async function unscheduleVideo(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/delete/scheduledvideo`,
      null,
      {
        params: {
          scheduledId: scheduledId,
...
async function unscheduleReel(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/delete/scheduledreel`,
      null,
      {
        params: {
          scheduledId: scheduledId,
...
async function unscheduleCarousel(
  scheduledId: string,
  workspaceId: string,
  userId: string
) {
  try {
    ...
    toast.loading('Unscheduling Carousel...', {
      className: 'text-sm silka-medium text-gray-900',
      duration: 80000,
    });

    const result = await axios.post(
      `${apiUrl()}instagram/delete/scheduledcarousel`,
      null,
      {
        params: {
          scheduledId: scheduledId,
    ...
    if (result.data.message == 'success') {
      toast.remove();
      toast.success('Carousel successfully unscheduled!', {
        className: 'text-sm silka-medium text-gray-900',
      });
    }
    return result.data;
    ...
    toast.remove();
    toast.error('Error unscheduling carousel, please try again.', {
      className: 'text-sm silka-medium text-gray-900',
    });
    console.log(e);
  }
...
async function getScheduledPosts(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}instagram/read/scheduledposts`,
      {
        params: {
          workspaceId: workspaceId,
          userId: userId,
...
async function getMorePosts(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}instagram/read/morescheduled`,
      {
        params: {
          workspaceId: workspaceId,
          userId: userId,
            ...
            <div className="my-auto">
              ...
              >
                <DialogPrimitive.Trigger asChild>
                  <button className="my-auto py-1 px-3 rounded text-xs hover:bg-[#F6E7F3] hover:opacity-80 silka-semibold text-[#F604D0]">
                    Pick Post
                  </button>
...
export function InstagramScheduledPosts({ workspaceId }: Props) {
        ...
        <div className="flex flex-col space-y-5 md:space-y-0 md:flex-row md:justify-between md:items-between">
          <div className="flex flex-col">
            ...
            <p className="text-xs silka-regular text-gray-500">
              Upcoming posts scheduled to be posted on Instagram.
            </p>
          </div>
            ...
            >
              {moreLoading ? (
                <div className="flex flex-row space-x-3">
                  <span className="animate-ping h-2.5 w-2.5 my-auto rounded-full bg-[#F604D0] opacity-75"></span>
