...
interface Props {
  ...
  workspaceId: string;
  userId: string;
  refetchScheduledPosts: boolean;
  setRefetchScheduledPosts: Dispatch<SetStateAction<boolean>>;
}
...
async function getPostingSchedule(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}instagram/read/myschedule`,
      {
        params: {
...
async function createSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/create/scheduletime`,
      null,
      {
        params: {
          workspaceId: workspaceId,
...
async function deleteSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/delete/schedule`,
      null,
      {
        params: {
...
async function updateSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/update/schedule`,
      null,
      {
        params: {
          scheduleId: scheduleId,
          ...
          >
            <CheckboxPrimitive.Root
              ...
              className={cx(
                ...
                'radix-state-checked:bg-[#F604D0] radix-state-unchecked:bg-gray-100',
                'focus:outline-none focus-visible:ring focus-visible:ring-[#F604D0] focus-visible:ring-opacity-75'
              )}
            >
...
export function InstagramScheduleTimesDialog({
  isOpen,
  workspaceId,
  userId,
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <div className="flex flex-col justify-center items-center space-y-1.5">
              ...
              <p className="text-xs silka-regular text-gray-400">
                Instagram schedule for posts to be scheduled on.
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col justify-start items-start w-full">
              <select
                ...
                className="focus:ring-0 focus:border-[#F604D0] w-24 py-1 rounded border border-gray-300 silka-medium text-sm text-gray-900"
              >
