...
async function nextTimeSlot(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/create/reelnexttimeslot`,
      null,
      {
        params: {
    ...
    console.log(e);
    toast.remove();
    toast.error('Error scheduling reel, please try agian.', {
      className: 'text-sm silka-medium text-gray-900',
    });
  }
}
...
export function InstagramScheduleReel({
  isOpen,
  setIsOpen,
  workspaceId,
  autoRepostOpen,
          ...
          >
            <div className="w-full flex flex-col justify-center items-center">
              ...
              <p className="mt-2.5 text-xs silka-regular text-gray-400">
                Schedule reel to be posted on Instagram.
              </p>
            </div>
