...
import { InstagramPostCarouselNow } from '../dialog/PostCarouselNow';
import { InstagramScheduleCarousel } from '../dialog/ScheduleCarousel';
import { InstagramCarouselTimeSlots } from '../dialog/CarouselAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}instagram/read/draftcarouseloptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/update/draftcarouseloptions`,
      null,
      {
        params: {
...
export function InstagramCarouselOptions({
  workspaceId,
  draftId,
  postText,
  carouselMedia,
