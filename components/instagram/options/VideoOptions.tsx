...
import { InstagramPostVideoNow } from '../dialog/PostVideoNow';
import { InstagramScheduleVideo } from '../dialog/ScheduleVideo';
import { InstagramVideoTimeSlots } from '../dialog/VideoAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}instagram/read/draftvideooptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/update/draftvideooptions`,
      null,
      {
        params: {
...
export function InstagramVideoOptions({
  workspaceId,
  draftId,
  postText,
  setSelectedVideo,
