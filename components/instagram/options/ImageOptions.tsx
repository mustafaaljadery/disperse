...
import { InstagramScheduleImage } from '../dialog/ScheduleImage';
import { InstagramPostImageNow } from '../dialog/PostImageNow';
import { InstagramImageTimeSlots } from '../dialog/ImageAvailableTimeSlots';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}instagram/read/draftimageoptions`,
      {
        params: {
          draftId: draftId,
        },
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}instagram/update/draftimageoptions`,
      null,
      {
        params: {
...
export function InstagramImageOptions({
  workspaceId,
  draftId,
  postText,
  imageMedia,
    ...
    <div className="flex flex-col mt-6 w-full">
      ...
      >
        <InstagramImageTimeSlots
          ...
          setRefetchImages={setRefetchImageDrafts}
          setSelectedImage={setSelectedImage}
        />
      </DialogPrimitive.Root>
    </div>
