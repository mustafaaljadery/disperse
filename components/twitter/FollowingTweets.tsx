...
async function getTweets(workspaceId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}twitter/read/followingtweets`,
      {
...
function TweetAndReplyComponent({
  ...
  const [likes, setLikes] = useState(
    tweets[index].public_metrics.like_count
  );
  const [retweets, setRetweets] = useState(
    tweets[index].public_metrics.retweet_count
  );
  ...
  useEffect(() => {
    setLikes(tweets[index].public_metrics.like_count);
    setRetweets(tweets[index].public_metrics.retweet_count);
  }, []);
          ...
          <div className="flex flex-row space-x-3">
            ...
            <div className="flex flex-col space-y-1">
              ...
              <div className="flex flex-row space-x-1">
                ...
                <span className="text-xs lg:text-[11px] xl:text-sm silka-regular text-gray-500">
                  {formatLargeNumber(
          ...
          <div className="mt-4 flex flex-row justify-between items-between">
            <div className="flex flex-row space-x-2 md:space-x-0.5 xl:space-x-4 my-auto">
              ...
              <button
                ...
                className={
                  'flex flex-row space-x-2 px-3 md:px-1.5 xl:px-4 py-1 md:py-1.5 rounded ' +
                  (retweeted
                    ? 'hover:bg-gray-200'
                    : 'hover:bg-[#E7F2E4]')
                }
...
export function FollowingTweets({ workspaceId }: Props) {
