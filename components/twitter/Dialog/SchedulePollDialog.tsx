...
interface SchedulePollDialogProps {
  isOpen: boolean;
...
async function nextTimeSlot(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}twitter/create/pollnexttimeslot`,
      null,
      {
        params: {
...
export function SchedulePollDialog({
  isOpen,
  tweetText,
  pollFields,
  workspaceId,
        ...
        >
          <div className="w-full flex flex-col justify-center items-center">
            ...
            <p className="mt-2.5 text-xs silka-regular text-gray-400">
              Schedule poll to be posted on Twitter.
            </p>
          </div>
