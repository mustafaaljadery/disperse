...
interface Props {
  ...
  workspaceId: string;
  userId: string;
  refetchScheduledTweets: boolean;
  setRefetchScheduledTweets: Dispatch<SetStateAction<boolean>>;
}
...
async function getPostingSchedule(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}twitter/read/myschedule`,
      {
        params: {
...
async function createSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}twitter/create/scheduletime`,
      null,
      {
        params: {
          workspaceId: workspaceId,
...
async function deleteSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}twitter/delete/schedule`,
      null,
      {
        params: {
...
async function updateSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}twitter/update/schedule`,
      null,
      {
        params: {
          scheduleId: scheduleId,
        ...
        <button
          onClick={(e) => {
            ...
            deleteSchedule(value.id, workspaceId, userId).then(() => {
              setRefetchScheduledTweets(true);
            });
            setScheduleData(
...
export function TwitterScheduleTimesDialog({
  isOpen,
  workspaceId,
  userId,
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <div className="flex flex-col justify-center items-center space-y-1.5">
              ...
              <p className="text-xs silka-regular text-gray-400">
                Twitter schedule for tweets to be scheduled on.
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col justify-start items-start w-full">
              <select
                ...
                className="focus:ring-0 focus:border-[#1D9BF0] w-24 py-1 rounded border border-gray-300 silka-medium text-sm text-gray-900"
              >
