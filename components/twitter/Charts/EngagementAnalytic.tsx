...
interface EngagementAnalyticProps {
  workspaceId: string;
  engagements: any;
  impressions: any;
  isPremium: boolean;
...
async function getEngagementData(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}twitter/read/engagements`,
      {
        params: {
...
export function EngagementAnalytic({
  workspaceId,
  engagements,
  impressions,
  isPremium,
}: EngagementAnalyticProps) {
  ...
  useEffect(() => {
    if (engagements != null) {
      if (isPremium) {
        ...
        getEngagementData(workspaceId, engagements).then((value) => {
