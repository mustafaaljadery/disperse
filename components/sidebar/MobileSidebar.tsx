...
import { SidebarMediaMobile } from './SidebarMediaMobile';
...
export function MobileSidebar({
  ...
  const [bottomHeight, setBottomHeight] = useState<any>(null);
  const [mediaHeight, setMediaHeight] = useState<any>(0);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      if (windowHeight && otherHeight && bottomHeight) {
  ...
  }, [windowHeight, otherHeight, bottomHeight, isOpen]);

  return (
    <>
      <button
        ref={btnRef}
        className="lg:hidden p-1 rounded hover:bg-gray-100 my-auto"
        onClick={onOpen}
      >
        <svg
          width="18"
      ...
      >
        ...
        <DrawerContent
          ref={ref}
          className="bg-[#FBFBFA] pt-4 flex z-50 h-[100vh] flex-col space-y-3 justify-between items-between"
        >
          <div ref={otherRef} className="flex flex-col space-y-5">
              ...
              >
                <DialogPrimitive.Trigger asChild>
                  <button
                    ...
                    className="w-[85%] flex flex-row space-x-2 bg-white shadow rounded py-1 px-2 hover:opacity-90"
                  >
                    <NewMediaIcon />
              ...
              >
                <DialogPrimitive.Trigger asChild>
                  <button
                    ...
                    className="w-[15%] bg-white shadow rounded flex flex-col justify-center items-center"
                  >
                    <SearchIcon />
                  </button>
                </DialogPrimitive.Trigger>
            ...
            <div className="flex flex-col w-full space-y-1.5 px-2">
              <Link href={'/' + workspaceId} legacyBehavior>
                <button
                  className={
                    'flex flex-row w-full space-x-2 rounded hover:bg-gray-100 py-1.5 px-2 ' +
                ...
                >
                  ...
                  <a
                    className={'silka-medium text-sm text-[#474747] '}
                  >
                    Dashboard
                  </a>
                </button>
              ...
              <Link href={'/' + workspaceId + '/edit'}>
                <button
                  className={
                    ...
                    (String(completePath).includes('edit')
                      ? 'bg-gray-100'
                      : '')
                  }
                >
              ...
              >
                <button
                  className={
                    'flex flex-row w-full space-x-2 rounded hover:bg-gray-100 py-1.5 px-2 ' +
                    (completePath.includes('automation')
                      ? 'bg-gray-100'
                      : '')
                  }
                >
              ...
              <Link href={'/' + workspaceId + '/referral'}>
                <button
                  className={
                    'flex flex-row w-full space-x-2 rounded hover:bg-gray-100 py-1.5 px-2 ' +
                    (completePath.includes('referral')
                      ? 'bg-gray-100'
                      : '')
                  }
                >
              ...
              >
                <button
                  className={
                    'flex w-full flex-row space-x-2 rounded hover:bg-gray-100 py-1.5 px-2 ' +
                    (completePath.includes('settings')
                      ? 'bg-gray-100'
                      : '')
                  }
                >
          ...
          <SidebarMediaMobile
            ...
            fullPathname={completePath}
          />
          <div ref={bottomRef} className="flex flex-col h-fit">
            <hr className="w-full" />
            <Link href={'/dashboard'} legacyBehavior>
              <button className="px-3 py-3 hover:bg-gray-100 flex flex-row space-x-2.5">
                <svg
                  width="13"
                  height="13"
                  viewBox="0 0 15 15"
