...
function Project({
  ...
  return (
    <button
      ...
      className={
        'flex hover:bg-gray-100 text-start flex-row space-x-2 rounded w-full py-1 px-2 ' +
        (pathname == projectId ? 'bg-gray-100' : '')
      }
    >
...
export function SidebarMediaAndSocials({
  workspaceId,
  pathname,
  mediaHeight,
  bottomHeight,
  ...
  const [minusFactor, setMinusFactor] = useState(80);
  ...
  const Div = styled('div', {
    height: mediaHeight - minusFactor + 'px',
  });
