...
import { LinkedinScheduleTimesDialog } from './ScheduleTimes';
import { LinkedinPickPost } from './dialogs/PickPost';
...
async function getThumbnail(fileId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}linkedin/read/thumbnail`,
      {
        params: {
          fileId: fileId,
        },
...
async function unscheduleText(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/delete/scheduledtext`,
      null,
      {
        params: {
...
async function unscheduleImage(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/delete/scheduledimage`,
      null,
      {
        params: {
          scheduledId: scheduledId,
...
async function unscheduleVideo(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/delete/scheduledvideo`,
      null,
      {
        params: {
          scheduledId: scheduledId,
...
async function unscheduleMultiimage(
  scheduledId: string,
  workspaceId: string,
  userId: string
) {
  try {
    ...
    toast.loading('Unscheduling Multi-Image...', {
      className: 'text-sm silka-medium text-gray-900',
      duration: 80000,
    });

    const result = await axios.post(
      `${apiUrl()}linkedin/delete/scheduledmultiimage`,
      null,
      {
        params: {
          scheduledId: scheduledId,
    ...
    if (result.data.message == 'success') {
      toast.remove();
      toast.success('Multi-Image successfully unscheduled!', {
        className: 'text-sm silka-medium text-gray-900',
      });
    }
    return result.data;
    ...
    toast.remove();
    toast.error('Error unscheduling multi-image, please try again.', {
      className: 'text-sm silka-medium text-gray-900',
    });
    console.log(e);
  }
...
async function unschedulePoll(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/delete/scheduledpoll`,
      null,
      {
        params: {
          scheduledId: scheduledId,
...
async function getScheduledPosts(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}linkedin/read/scheduledposts`,
      {
        params: {
          workspaceId: workspaceId,
          userId: userId,
...
async function getMorePosts(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}linkedin/read/morescheduled`,
      {
        params: {
          workspaceId: workspaceId,
          cursor: cursor,
            ...
            <div className="my-auto">
              ...
              >
                <DialogPrimitive.Trigger asChild>
                  <button className="my-auto py-1 px-3 rounded text-xs hover:bg-[#E8EDF3] hover:opacity-80 silka-semibold text-[#0966C2]">
                    Pick Post
                  </button>
...
export function LinkedinScheduledPosts({ workspaceId }: Props) {
        ...
        <div className="flex flex-col space-y-5 md:space-y-0 md:flex-row md:justify-between md:items-between">
          <div className="flex flex-col">
            ...
            <p className="text-xs silka-regular text-gray-500">
              Upcoming posts scheduled to be posted on Linkedin.
            </p>
          </div>
