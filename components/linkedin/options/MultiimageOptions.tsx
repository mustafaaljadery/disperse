...
import { LinkedinPostMultiimageNow } from '../dialogs/PostMultiimageNow';
import { LinkedinMultiimageAvailableTimeSlot } from '../dialogs/MultiimageAvailableTimeSlot';
import { LinkedinScheduleMultiimage } from '../dialogs/ScheduleMultiimage';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}linkedin/read/draftmultiimageoptions`,
      {
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/update/draftmultiimageoptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function MultiimageOptions({
  workspaceId,
  draftId,
  postText,
  ...
  return (
    <div className="flex flex-col mt-6">
      ...
      >
        <LinkedinMultiimageAvailableTimeSlot
          workspaceId={workspaceId}
          userId={String(session?.user?.id)}
          draftId={draftId}
