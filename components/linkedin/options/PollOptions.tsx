...
import { LinkedinPostPollNow } from '../dialogs/PostPollNow';
import { LinkedinPollAvailableTimeSlot } from '../dialogs/PollAvailableTimeSlot';
import { LinkedinSchedulePoll } from '../dialogs/SchedulePoll';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}linkedin/read/draftpolloptions`,
      {
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/update/draftpolloptions`,
      null,
      {
        params: {
          draftId: draftId,
  ...
  return (
    <div className="flex flex-col mt-6">
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="mt-2 text-xs silka-regular text-gray-500">
      ...
      <button
        ...
        className="flex flex-row space-x-1 justify-start items-start mt-8"
      >
