...
import { LinkedinPostImageNow } from '../dialogs/PostImageNow';
import { LinkedinScheduleImage } from '../dialogs/ScheduleImage';
import { useSession } from 'next-auth/react';
import { LinkedinImageAvailableTimeSlot } from '../dialogs/ImageAvailableTimeSlot';
...
async function getOptions(draftId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}linkedin/read/draftimageoptions`,
      {
...
async function updateOptions(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/update/draftimageoptions`,
      null,
      {
        params: {
          draftId: draftId,
...
export function ImageOptions({
  ...
  return (
    <div className="flex flex-col mt-6">
      ...
      <div className="flex flex-row justify-center items-center mt-8 space-x-5">
        ...
        >
          ...
          <LinkedinPostImageNow
            ...
            setRefetchImageDrafts={setRefetchDrafts}
      ...
      >
        <LinkedinImageAvailableTimeSlot
          workspaceId={workspaceId}
          userId={String(session?.user?.id)}
          draftId={draftId}
