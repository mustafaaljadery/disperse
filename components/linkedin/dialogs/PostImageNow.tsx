...
async function postImageNow(
  ...
  try {
    ...
    toast.loading('Posting Image...', {
      className: 'text-sm silka-medium text-gray-900',
      duration: 80000,
    });
    const result = await axios.post(
      `${apiUrl()}linkedin/create/postimage`,
      null,
      {
        params: {
...
export function LinkedinPostImageNow({
  isOpen,
  setIsOpen,
  removeUrlPreview,
  autoPlugOpen,
          ...
          >
            <div className="w-full flex flex-col justify-center items-center">
              ...
              <p className="mt-2.5 text-xs silka-regular text-gray-400">
                Post image on Linkedin right now.
              </p>
            </div>
              ...
              <button
                onClick={(e) => {
                  ...
                  if (autoReshareOpen && reshareInputValue == 0) {
                    ...
                    toast.error(
                      'Please select an image to be posted.',
                      {
                        className:
