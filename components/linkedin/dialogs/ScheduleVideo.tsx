...
async function nextTimeSlot(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/create/videonexttimeslot`,
      null,
      {
        params: {
...
export function LinkedinScheduleVideo({
  isOpen,
  setIsOpen,
  workspaceId,
  removeUrlPreview,
          ...
          >
            <div className="w-full flex flex-col justify-center items-center">
              ...
              <p className="mt-2.5 text-xs silka-regular text-gray-400">
                Schedule video to be posted on Linkedin.
              </p>
            </div>
            ...
            <div className="mt-7 flex flex-col space-y-2.5">
              <button
                onClick={(e) => {
                  ...
                  } else if (!videoMedia?.id) {
                    toast.error('Video is missing from post.', {
                      className: 'text-gray-900 text-sm silka-medium',
                    });
                  } else if (postText?.length == 0) {
                    toast.error('Post is missing text.', {
                      className: 'text-gray-900 text-sm silka-medium',
                    });
                  } else {
