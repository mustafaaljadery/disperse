...
async function getPostingSchedule(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}linkedin/read/myschedule`,
      {
        params: {
...
async function createSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/create/scheduletime`,
      null,
      {
        params: {
          workspaceId: workspaceId,
...
async function deleteSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/delete/schedule`,
      null,
      {
        params: {
...
async function updateSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}linkedin/update/schedule`,
      null,
      {
        params: {
          scheduleId: scheduleId,
...
export function LinkedinScheduleTimesDialog({
  isOpen,
  workspaceId,
  userId,
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <div className="flex flex-col justify-center items-center space-y-1.5">
              ...
              <p className="text-xs silka-regular text-gray-400">
                Linkedin schedule for posts to be scheduled on.
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col justify-start items-start w-full">
              <select
                ...
                className="focus:ring-0 focus:border-[#0966C2] w-24 py-1 rounded border border-gray-300 silka-medium text-sm text-gray-900"
              >
