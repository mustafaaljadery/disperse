...
export function LinkedinMenu({ title, router, workspaceId }: Props) {
  return (
        ...
        <div className="flex flex-row space-x-2">
          <Link
            ...
            className={
              ...
              (router.pathname == '/[workspaceId]/linkedin'
                ? 'silka-semibold underline underline-offset-[21px] z-10 decoration-2 decoration-[#0966C2] text-[#353535]'
          ...
          <Link
            href={'/' + workspaceId + '/linkedin/posts'}
            className={
              'hover:bg-gray-100 rounded py-1 px-3 text-xs md:text-sm ' +
              (router.pathname == '/[workspaceId]/linkedin/posts'
                ? 'silka-semibold underline underline-offset-[21px] z-10 decoration-2 decoration-[#0966C2] text-[#353535]'
                : 'text-[#848484] silka-medium')
            }>
