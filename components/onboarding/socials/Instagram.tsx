...
export function OnboardingInstagram({
  isOpen,
  setIsOpen,
  userId,
            ...
            <div className="mt-6 w-full">
              ...
              >
                <div className="flex flex-row space-x-2">
                  <p className="silka-semibold my-auto text-start text-[11px] text-[#D90100]">
                    Make sure it's a business account that is
                    connected to a Facebook Page. Follow the Guide
                    below
                  </p>
                  <svg
                    width="12"
