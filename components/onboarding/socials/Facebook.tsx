...
export function OnboardingFacebook({
  isOpen,
  setIsOpen,
  userId,
          ...
          >
            ...
            <div className="mt-6 flex flex-col">
              ...
              <button
                ...
                disabled={connected}
                className={
                  'py-2 w-full mt-4 bg-[#0A7BEA] text-sm text-white silka-semibold rounded ' +
              ...
              {connecting && (
                <div className="mt-4 flex flex-row space-x-2 justify-center items-center">
                  <div className="flex flex-row space-x-3">
                    <span className="animate-ping h-2.5 w-2.5 my-auto rounded-full bg-[#0A7BEA] opacity-75"></span>
