...
function Account({
  ...
  return (
    <button
      ...
      className="py-1 flex flex-row space-x-2.5 hover:opacity-80"
    >
      <div
        className={
          'h-[14px] w-[14px] rounded-full my-auto flex flex-col justify-center items-center ' +
...
export function InstagramSelectAccountAutomation({
  workspaceId,
  isOpen,
  setIsOpen,
  setRefetchConnected,
