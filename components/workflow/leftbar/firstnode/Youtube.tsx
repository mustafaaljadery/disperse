...
import { AutomationConnectYoutube } from '../../dialog/ConnectYoutube';
            ...
            onClick={(e) => {
              ...
              updateYoutubeTested(
                ...
                if (value.message == 'tested') {
                  ...
                  toast.success('Youtube Successfully Tested!', {
                    className: 'text-sm silka-medium text-gray-900',
                  });
                } else {
                  setYoutubeTested(false);
                  toast.error('Failed Testing Youtube Connection', {
                    className: 'text-sm silka-medium text-gray-900',
                  });
                }
              });
...
function Account({
  ...
  const [connectYoutubeOpen, setConnectYoutubeOpen] = useState(false);
              ...
              {youtubeData?.message == 'found' ? (
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  <DialogPrimitive.Root
                    open={connectYoutubeOpen}
                    onOpenChange={setConnectYoutubeOpen}
                  >
                    ...
                    <AutomationConnectYoutube
                      isOpen={connectYoutubeOpen}
                      setIsOpen={setConnectYoutubeOpen}
                      workspaceId={workspaceId}
...
export default function YoutubeFirstLeftBar({
  workflowData,
  firstErrors,
  setFirstErrors,
  leftState,
