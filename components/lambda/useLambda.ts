...
export const useLambda = (id: string, inputProps: any, refreshInterval = 3000) => {
  ...
  const getUrl = (id: string) => `https://remotionlambda-useast1-1o6msbedi5.s3.amazonaws.com/renders/${id}/out.mp4`;
