...
async function createSchedule(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}tiktok/create/scheduletime`,
      null,
      {
        params: {
          workspaceId: workspaceId,
          ...
          >
            <CheckboxPrimitive.Root
              ...
              className={cx(
                ...
                'radix-state-checked:bg-[#363636] radix-state-unchecked:bg-gray-100',
                'focus:outline-none focus-visible:ring focus-visible:ring-[#363636] focus-visible:ring-opacity-75'
              )}
            >
...
export function TiktokScheduleTimesDialog({
  isOpen,
  workspaceId,
  userId,
          ...
          <div className="flex flex-col justify-center items-center w-full">
            <div className="flex flex-col justify-center items-center space-y-1.5">
              ...
              <p className="text-xs silka-regular text-gray-400">
                TikTok schedule for videos to be scheduled on.
              </p>
            </div>
            ...
            <div className="mt-6 flex flex-col justify-start items-start w-full">
              <select
                ...
                className="focus:ring-0 focus:border-[#363636] w-24 py-1 rounded border border-gray-300 silka-medium text-sm text-gray-900"
              >
