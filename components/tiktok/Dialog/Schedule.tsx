...
async function nexttimeSlot(
  ...
  try {
    ...
    const result = await axios.post(
      `${apiUrl()}tiktok/create/nexttimeslot`,
      null,
      {
        params: {
...
interface TiktokScheduleDialogProps {
  isOpen: boolean;
...
export function TiktokScheduleDialog({
  isOpen,
  setIsOpen,
  workspaceId,
  autoRepostOpen,
        ...
        >
          <div className="w-full flex flex-col justify-center items-center">
            ...
            <p className="mt-2.5 text-xs silka-regular text-gray-400">
              Schedule video to be posted on TikTok.
            </p>
          </div>
