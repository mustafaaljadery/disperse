...
interface TitkokFollowersChartProps {
  timeInterval: string;
  workspaceId: string;
  followers: any;
  isPremium: boolean;
...
async function getTotalFollowers(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}tiktok/read/totalfollowers`,
      {
        params: {
...
async function getDailyFollowers(
  ...
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}tiktok/read/dailyfollowers`,
      {
        params: {
          workspaceId: workspaceId,
          timeInterval: timeInterval,
...
export function TiktokFollowersChart({
  timeInterval,
  workspaceId,
  followers,
  isPremium,
}: TitkokFollowersChartProps) {
