...
import { TiktokProfileComponent } from './ProfileComponent';
...
interface TiktokAnalyticsHeaderProps {
  workspaceId: string;
...
export function TiktokAnalyticsHeader({
  workspaceId,
  timeIncrement,
  setTimeIncrement,
  isPremium,
}: TiktokAnalyticsHeaderProps) {
    ...
    <div className="flex flex-col">
      {!isPremium && (
        <div className="w-full py-6 border border-gray-200 rounded-lg flex flex-col justify-center items-center space-y-5">
          ...
          <p className="px-4 sm:px-6 md:px-10 lg:px-16 xl:px-32 text-sm silka-regular text-gray-600 text-center">
            Upgrade to pro to view all of your TikTok{' '}
          ...
          <div>
            ...
            >
              <DialogPrimitive.Trigger asChild>
                <button className="flex flex-row space-x-2 rounded hover:opacity-80 py-1.5 px-6 bg-[#363636]">
                  <svg
                    width="15"
                    height="15"
                    viewBox="0 0 15 15"
      ...
      >
        <TiktokProfileComponent
          ...
          profile_image_url={userInfo?.user?.avatar_large_url}
          description={userInfo?.user?.bio_description}
          isPremium={isPremium}
          isLoading={isLoading}
        />
