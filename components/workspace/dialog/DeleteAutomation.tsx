...
export function DeleteAutomationDialog({ isOpen }: Props) {
  ...
  async function handleSubmit() {
    const confirm = 'I WANT TO DELETE THIS WORKFLOW';
        ...
        >
          ...
          <form className="mt-3">
            <p className="text-sm silka-medium text-[#3D3D3D]">
              Are you sure you want to delete this workflow? By doing
              so, you will lose the data saved with this workflow.
            </p>
