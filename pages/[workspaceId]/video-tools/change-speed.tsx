...
async function changeSpeed(
  ...
  try {
    const result = await axios.post(
      `${apiUrl()}editor/create/changespeed`,
      null,
      {
        params: {
...
const formats = [
  {
    image: '/images/edit/super-slow.png',
    name: 'Super Slow',
    value: '25% / 0.25x',
    speed: 0.25,
  },
  {
    image: '/images/edit/slow.png',
    name: 'Slow',
    value: '50% / 0.5x',
    speed: 0.5,
  },
  {
    image: '/images/edit/normal.png',
    name: 'Normal',
    value: '100% / 1x',
    speed: 1,
  },
  {
    image: '/images/edit/fast.png',
    name: 'Fast',
    value: '150% / 1.5x',
    speed: 1.5,
  },
  {
    image: '/images/edit/super-fast.png',
    name: 'Super Fast',
    value: '200% / 2x',
    speed: 2,
  },
...
export default function ChangeSpeed() {
  ...
  return (
    <PageHead title="Change Speed · Disperse Video Tools">
      <ToolsLayout workspaceId={workspaceId} title="Change Speed">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="mt-2 flex flex-row flex-wrap">
                    {formats.map((value: any, index: number) => {
                      return (
                        <div key={index} className="w-1/3 p-3.5">
                          <button
                            disabled={!file}
                            onClick={() => {
                          ...
                          >
                            <img
                              ...
                              className="rounded"
                            />
                            <p className="mt-1 text-sm silka-semibold text-gray-900">
                              {value?.name}
                            </p>
                            <span className="mt-1 text-[10px] silka-medium text-gray-500">
                              {value?.value}
                            </span>
                          </button>
                        </div>
                  ...
                  <div className="mt-6 flex flex-col">
                    <p className="text-xs silka-medium text-">
                      Custom Speed
                    </p>
                    <input
                      disabled={!file}
                      type="number"
                      className="w-32 rounded mt-1.5 focus:ring-0 focus:border-[#FF623D] border border-gray-300 text-xs silka-medium text-[#363636]"
                      value={speed}
                      onChange={(e) => {
                        if (Number(e.target.value) == 0) {
                          setSpeed(1.0);
                        } else if (Number(e.target.value) > 16) {
                          setSpeed(16.0);
                        } else {
