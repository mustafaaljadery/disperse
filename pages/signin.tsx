...
export default function Login() {
  ...
  useEffect(() => {
    if (router.isReady) {
      if (router.query?.error == 'CredentialsSignin') {
        ...
        toast.success(String(router?.query?.message), {
          className: 'text-sm silka-medium text-gray-900',
        });
      }
    }
  ...
  return (
    <PageHead
      title="Sign In - Disperse Content Automation"
      description="Welcome back, sign in to your Disperse account"
    >
      <div className="flex flex-col justify-center items-center">
        <div className="mt-10 w-[95%] md:w-4/5 lg:w-1/2 xl:w-[30%] flex flex-col justify-center items-center px-4">
          ...
          <button
            ...
            onClick={() =>
              signIn('google', {
                callbackUrl: 'https://www.trydisperse.com/dashboard',
              })
            }
          >
            <svg
          ...
          */}
          <div className="flex flex-col justify-center items-center mt-12 space-y-4">
            <Link
              href="/reset-password"
              className="text-[#FF623D] hover:underline text-center text-xs silka-medium"
            >
              Forgot Password?
            </Link>
