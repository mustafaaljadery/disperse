var createFFmpegCore = (function () {
  ...
  return function (createFFmpegCore) {
    ...
    f ||
      (f =
        typeof createFFmpegCore !== 'undefined'
          ? createFFmpegCore
          : {});
    var ba, ca;
    ...
    function fb() {
      ...
      if (
        0 == ab &&
        (null !== bb && (clearInterval(bb), (bb = null)), cb)
      ) {
        var a = cb;
        cb = null;
        a();
      ...
      return Ba ||
        ...
        : fetch(hb, { credentials: 'same-origin' })
            .then(function (a) {
              if (!a.ok)
                throw (
                  "failed to load wasm binary file at '" + hb + "'"
                );
      ...
      vi: function (a, b) {
        a.onmessage = function (c) {
          ...
          if (d.targetThread && d.targetThread != (pb | 0)) {
            ...
            ya('Thread ' + d.threadId + ': ' + d.text);
          else if ('printErr' === e)
            u('Thread ' + d.threadId + ': ' + d.text);
          else if ('alert' === e)
    ...
    function Vb(a, b) {
      ...
      b = c(b.split('/'));
      for (
        var d = Math.min(a.length, b.length), e = d, g = 0;
        g < d;
        g++
      )
        if (a[g] !== b[g]) {
    ...
    var Yb = {
        ...
        df: {
          ...
          write: function (a, b, c, d, e, g) {
            ...
            if (b.subarray && (!a.bf || a.bf.subarray)) {
              ...
              if (e + d <= a.gf)
                return a.bf.set(b.subarray(c, c + d), e), d;
            }
            P.sh(a, e + d);
      ...
      O = {
        ...
        write: function (a, b, c, d, e, g) {
          ...
          k || (a.position += b);
          try {
            if (a.path && O.mf.onWriteToFile)
              O.mf.onWriteToFile(a.path);
          } catch (m) {
            u(
        ...
        fg: function (a, b, c) {
          ...
          if (0 === (a.flags & 2097155)) throw new O.af(8);
          if (!O.isFile(a.node.mode) && !O.kf(a.node.mode))
            throw new O.af(43);
        ...
        bj: function (a, b, c, d, e) {
          ...
          g.prototype.kh = function () {
            ...
            if (
              ...
              throw Error(
                "Couldn't load " + c + '. Status: ' + q.status
              );
            var t = Number(q.getResponseHeader('Content-length')),
              w,
              B =
                (w = q.getResponseHeader('Accept-Ranges')) &&
                'bytes' === w;
            q =
              (w = q.getResponseHeader('Content-Encoding')) &&
              'gzip' === w;
            var p = 1048576;
            B || (p = t);
            var x = this;
            x.Wh(function (z) {
              ...
              if ('undefined' === typeof x.Sf[z]) {
                ...
                K.open('GET', c, !1);
                t !== p &&
                  K.setRequestHeader('Range', 'bytes=' + I + '-' + W);
                ...
                if (
                  ...
                  throw Error(
                    "Couldn't load " + c + '. Status: ' + K.status
                  );
                I =
                  void 0 !== K.response
    ...
    function kc(a, b, c, d, e) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && ua instanceof O.af) || n(ua),
          -ua.ef
        );
      }
    }
    function lc(a, b) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && e instanceof O.af) || n(e),
          -e.ef
        );
      }
    }
    function mc(a, b, c) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && g instanceof O.af) || n(g),
          -g.ef
        );
      }
    }
    function nc(a, b) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && d instanceof O.af) || n(d),
          -d.ef
        );
      }
    }
    function oc(a, b, c) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && t instanceof O.af) || n(t),
          -t.ef
        );
      }
    }
    function pc(a, b) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && c instanceof O.af) || n(c),
          -c.ef
        );
      }
    }
    ...
    function uc(a, b, c, d, e, g) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && w instanceof O.af) || n(w),
          -w.ef
        );
      }
    }
    function wc(a, b) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && r instanceof O.af) || n(r),
          -r.ef
        );
      }
    }
    ...
    function Cc(a) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && b instanceof O.af) || n(b),
          -b.ef
        );
      }
    }
    var R = {
      jf: function () {
        f.websocket =
          f.websocket && 'object' === typeof f.websocket
            ? f.websocket
            : {};
        f.websocket.Ig = {};
        ...
        f.websocket.emit = function (a, b) {
          'function' === typeof this.Ig[a] &&
            this.Ig[a].call(this, b);
        };
      ...
      mi: function (a) {
        return (a = O.zf(a)) && O.isSocket(a.node.mode)
          ? a.node.bg
          : null;
      },
      df: {
      ...
      qf: {
        ...
        connect: function (a, b, c) {
          ...
          if (
            'undefined' !== typeof a.sf &&
            'undefined' !== typeof a.vf
          ) {
        ...
        fh: function (a, b, c, d, e, g) {
          ...
          if (
            2 === a.type &&
            (!k || k.socket.readyState !== k.socket.OPEN)
          )
            return (
              (k &&
                k.socket.readyState !== k.socket.CLOSING &&
        ...
        bh: function (a, b) {
          ...
          1 === a.type &&
            b < d &&
            ((c.data = new Uint8Array(g, e + b, d - b)),
            a.ag.unshift(c));
          return k;
        },
      },
    ...
    function Ec(a) {
      ...
      0 < a.indexOf('.')
        ? ((a = a.replace(/[.]/g, ':')),
          (a = a.split(':')),
          (a[a.length - 4] =
            parseInt(a[a.length - 4]) +
            256 * parseInt(a[a.length - 3])),
          (a[a.length - 3] =
            parseInt(a[a.length - 2]) +
            256 * parseInt(a[a.length - 1])),
    ...
    function Qc(a, b) {
      ...
      try {
        ...
        switch (a) {
          ...
          case 3:
            return (
              (k = b()), (m = c()), k.pf.connect(k, m.hf, m.port), 0
            );
          case 4:
            k = b();
            var r = Q();
        ...
        return (
          ('undefined' !== typeof O && aa instanceof O.af) || n(aa),
          -aa.ef
        );
      }
    }
    ...
    function xd(a, b, c, d, e) {
      ...
      return a.subarray(
        ...
        (e +
          d *
            ((c *
              ({ 5: 3, 6: 4, 8: 2, 29502: 3, 29504: 4 }[b - 6402] ||
                1) *
              (1 << g) +
              k -
              1) &
    ...
    function Od(a, b, c, d) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && q instanceof O.af) || n(q),
          q.ef
        );
      }
    }
    function Pd(a, b, c, d, e) {
      ...
      try {
        ...
        return (
          ('undefined' !== typeof O && k instanceof O.af) || n(k),
          k.ef
        );
      }
    }
    ...
    function Sd(a) {
      ...
      var b = 'Unknown error';
      a in Rd &&
        (255 < Rd[a].length ? (b = 'Message too long') : (b = Rd[a]));
      Pa(b, Sd.buffer);
      return Sd.buffer;
    }
    function Td(a, b, c, d) {
      ...
      if (null !== g)
        if (0 === r || 2 === r) r = 2;
          ...
          (g = [0, 0, Ud(65535), g]), (r = 10);
        else return -2;
      else if (((g = Ec(a)), null !== g))
        if (0 === r || 10 === r) r = 10;
        else return -2;
      if (null != g)
        return (a = e(r, q, t, a, g, k)), (E[d >> 2] = a), 0;
      if (m & 4) return -2;
      a = Jc(a);
      g = Dc(a);
    ...
    function Xd(a, b) {
      if (!a)
        return (
          u('pthread_join attempted on a null thread pointer!'), 71
        );
      if (l && selfThreadId == a)
        return (
          u('PThread ' + a + ' is attempting to join to itself!'), 16
        );
      if (!l && M.xf == a)
        return (
          u('Main thread ' + a + ' is attempting to join to itself!'),
          16
        );
      if (E[(a + 12) >> 2] !== a)
        return (
      ...
      for (Uc(); ; ) {
        ...
        if (1 == c)
          return (
            ...
            l
              ? postMessage({ cmd: 'cleanupThread', thread: a })
              : vb(a),
            0
          );
        if (
    ...
    var Fe = {
      ...
      K: function (a, b) {
        ...
        if (!noExitRuntime)
          return (
            postMessage({ cmd: 'exitProcess', returnCode: a }), a
          );
      },
      W: function (a, b) {
        return Gb(a, b);
      ...
      $c: function (a, b) {
        for (var c = 0; c < a; c++) {
          var d = E[(b + 4 * c) >> 2],
            e = bd[d];
          e &&
            (V.deleteRenderbuffer(e), (e.name = 0), (bd[d] = null));
        }
      },
      _c: function (a) {
        if (a) {
      ...
      wc: function (a, b, c, d) {
        ...
        if (
          a instanceof WebGLRenderbuffer ||
            ...
            if (d)
              if (35716 == b)
                ...
                if (-1 == d.kg)
                  for (
                    a = S[a],
                      e = V.getProgramParameter(a, 35382),
                      b = d.kg = 0;
                    b < e;
                    ++b
                  )
      ...
      ic: function (a, b) {
        ...
        return (a = gd[a] && gd[a].Nh[b]) && 0 <= c && c < a[0]
          ? a[1] + c
          : -1;
      },
      kc: function (a, b, c) {
      ...
      Ra: function (a) {
        if (a === M.Ph)
          return (
            u('Main thread (id=' + a + ') cannot be canceled!'), 71
          );
        if (!a)
          return (
            u('pthread_cancel attempted on a null thread pointer!'),
            71
          );
        if (E[(a + 12) >> 2] !== a)
          return (
      ...
      n: function (a, b, c, d) {
        ...
        if (!a)
          return (
            u('pthread_create called with a null thread pointer!'), 28
          );
        var e = [];
      ...
      m: function (a, b, c, d) {
        ...
        q = {
          ...
          '%j': function (p) {
            return g(
              p.pg + Zd(Yd(p.rf + 1900) ? $d : ae, p.dg - 1),
              3
            );
          },
          '%m': function (p) {
    ...
    (function () {
      ...
      (function () {
        return Ba ||
          ...
          'function' !== typeof fetch
          ? c(b)
          : fetch(hb, { credentials: 'same-origin' }).then(function (
              e
            ) {
    ...
    var le = (f.___wasm_call_ctors = function () {
        return (le = f.___wasm_call_ctors = f.asm.Td).apply(
          null,
          arguments
        );
      }),
      ...
      Fb = (f.___errno_location = function () {
        return (Fb = f.___errno_location = f.asm.Wd).apply(
          null,
          arguments
        );
      }),
    ...
    f.___em_js__initPthreadsJS = function () {
      return (f.___em_js__initPthreadsJS = f.asm.ce).apply(
        null,
        arguments
      );
    };
    var Ud = (f._htonl = function () {
      ...
      Mb = (f.__get_tzname = function () {
        return (Mb = f.__get_tzname = f.asm.ee).apply(
          null,
          arguments
        );
      }),
      Lb = (f.__get_daylight = function () {
        return (Lb = f.__get_daylight = f.asm.fe).apply(
          null,
          arguments
        );
      }),
      Kb = (f.__get_timezone = function () {
        return (Kb = f.__get_timezone = f.asm.ge).apply(
          null,
          arguments
        );
      }),
    ...
    var yb = (f.___pthread_tsd_run_dtors = function () {
      ...
      Ab = (f._emscripten_main_thread_process_queued_calls =
        function () {
          return (Ab =
            f._emscripten_main_thread_process_queued_calls =
    ...
    var wb = (f._emscripten_register_main_browser_thread_id =
        function () {
      ...
      lb = (f._do_emscripten_dispatch_to_thread = function () {
        return (lb = f._do_emscripten_dispatch_to_thread =
          f.asm.qe).apply(null, arguments);
      });
    f._emscripten_async_run_in_main_thread = function () {
      return (f._emscripten_async_run_in_main_thread =
    ...
    f._emscripten_sync_run_in_main_thread_0 = function () {
      return (f._emscripten_sync_run_in_main_thread_0 =
        f.asm.te).apply(null, arguments);
    };
    f._emscripten_sync_run_in_main_thread_1 = function () {
      return (f._emscripten_sync_run_in_main_thread_1 =
        f.asm.ue).apply(null, arguments);
    };
    f._emscripten_sync_run_in_main_thread_2 = function () {
      return (f._emscripten_sync_run_in_main_thread_2 =
        f.asm.ve).apply(null, arguments);
    };
    f._emscripten_sync_run_in_main_thread_xprintf_varargs =
      function () {
    ...
    f._emscripten_sync_run_in_main_thread_3 = function () {
      return (f._emscripten_sync_run_in_main_thread_3 =
        f.asm.xe).apply(null, arguments);
    };
    var Ee = (f._emscripten_sync_run_in_main_thread_4 = function () {
      return (Ee = f._emscripten_sync_run_in_main_thread_4 =
        f.asm.ye).apply(null, arguments);
    });
    f._emscripten_sync_run_in_main_thread_5 = function () {
      return (f._emscripten_sync_run_in_main_thread_5 =
        f.asm.ze).apply(null, arguments);
    };
    f._emscripten_sync_run_in_main_thread_6 = function () {
      return (f._emscripten_sync_run_in_main_thread_6 =
        f.asm.Ae).apply(null, arguments);
    };
    f._emscripten_sync_run_in_main_thread_7 = function () {
      return (f._emscripten_sync_run_in_main_thread_7 =
    ...
    f._emscripten_tls_init = function () {
      return (f._emscripten_tls_init = f.asm.Fe).apply(
        null,
        arguments
      );
    };
    ...
    var Ge = (f.dynCall_vijjjid = function () {
        return (Ge = f.dynCall_vijjjid = f.asm.He).apply(
          null,
          arguments
        );
      }),
      He = (f.dynCall_iiiijj = function () {
        return (He = f.dynCall_iiiijj = f.asm.Ie).apply(
          null,
          arguments
        );
      });
