  ...
  return (
    <div className="h-[100vh] w-[100vw] flex flex-col justify-center items-center">
      <div className="flex flex-row space-x-5">
        ...
        <div className="h-[36px] my-auto w-[36px] rounded bg-gradient-to-tr from-[#F2A603] to-[#F604D0] flex flex-col justify-center items-center">
          <svg
      ...
      <p className="mt-4 text-[12px] text-center silka-medium text-gray-400 w-1/5">
        Connect an instagram to automate your content posting and
