...
export function TiktokNotConnected() {
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex flex-col justify-center items-center">
      <div className="flex flex-row space-x-5">
        ...
        <div className="h-[36px] my-auto w-[36px] rounded bg-black flex flex-col justify-center items-center">
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
      ...
      <p className="mt-4 text-[12px] text-center silka-medium text-gray-400 w-1/5">
        Connect your tiktok to begin posting content using Disperse.
      </p>
