...
import { TiktokNotConnected } from '../notconnected/TiktokNotConnected';
...
async function getConnected(workspaceId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}tiktok/read/isconnected`,
