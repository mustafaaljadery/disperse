...
import { FacebookNotConnected } from '../notconnected/FacebookNotConnected';
...
async function getConnected(workspaceId: string) {
  try {
    ...
    const result = await axios.get(
      `${apiUrl()}facebook/read/isconnected`,
...
export function SecureFacebook({
  loading,
  setLoading,
  children,
  setWorkspaceId,
