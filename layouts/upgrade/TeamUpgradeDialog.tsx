...
export function TeamUpgradeDialog({
  ...
  const products = {
    monthly: 'price_1N71gzKq4w9CjH7gKrcICrSO',
    annual: 'price_1N71gzKq4w9CjH7gww3DjSTv',
  };
          ...
          <div className="flex flex-col">
            <div className="flex flex-col">
              ...
              <p className="mt-1 text-xs silka-regular text-gray-500">
                Team-members, premium analytics, and more automations.
              </p>
            </div>
                      ...
                      <div className="flex flex-row justify-end items-end">
                        <PayPalButtons
                          ...
                          createSubscription={(data, actions) => {
                            if (billingInterval == 'monthly') {
                              return actions.subscription.create({
                                plan_id: 'P-7DU74599US2399026MQJAVOY',
                              });
                            } else {
                              return actions.subscription.create({
                                plan_id: 'P-3DV08067C6416804HMQJAUPQ',
                              });
                            }
                          }}
                          onApprove={(data, actions) => {
                            ...
                            return axios
                              .post(
                                `${apiUrl()}workspace/update/paypaladvanced`,
                                null,
                                {
                                  params: {
                                    subscriptionId:
